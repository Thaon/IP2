...
namespace Ip2
{
    public class PlayerWall : MonoBehaviour
    {
        ...
        //public class WallRunState  REMOVED FOR NOW
        //{
        ...
        void Update()
        {
            ...
            {
                // The player is facing a wall if a linecast between the 'wallCheck' objects hits anything on the wall layer.
